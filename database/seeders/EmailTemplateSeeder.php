    ...
    private function templates(): array
    {
        return [
            ...
            [
                ...
                'body_html' => '<p>Hello {{ vendor_name }},</p><p>{{ driver_name }} has been assigned to pick up shipment <strong>{{ shipment_number }}</strong>.</p><p>Destination warehouse: {{ warehouse_name }}.</p>',
                'body_text' => "Hello {{ vendor_name }},\n\n{{ driver_name }} has been assigned to pick up shipment {{ shipment_number }}.\nDestination warehouse: {{ warehouse_name }}.",
