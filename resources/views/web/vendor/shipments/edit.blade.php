...
@section('content')
<div x-data="vendorShipmentFormPage()" data-mode="edit" data-shipment-id="{{ $shipmentId }}">
    ...
    <div x-show="loading" class="flex items-center justify-center py-24">
        <div class="text-center">
            ...
            <p class="mt-4 text-sm font-medium text-slate-400">Loading shipment...</p>
        </div>
    </div>
        ...
        <div class="mb-4" x-show="validationErrors.length" x-cloak>
            <div class="rounded-lg border border-red-200 bg-red-50 px-4 py-3 text-sm text-red-700">
                ...
                <ul class="mt-1 list-disc space-y-0.5 pl-5 text-xs">
                    <template x-for="err in validationErrors" :key="err"><li x-text="err"></li></template>
                </ul>
            </div>
        </div>
            ...
            <div class="hidden lg:block">
                <div class="sticky top-20 space-y-4">
                    ...
                    <div class="overflow-hidden rounded-xl border border-blue-100 bg-gradient-to-br from-blue-50/50 via-white to-blue-50/30">
                        ...
                        <p class="px-3.5 py-3 text-[11px] leading-relaxed text-slate-600">Update your shipment details here. Items can be managed from the <strong class="font-semibold text-slate-700">shipment details</strong> page.</p>
                    </div>
                </div>
            </div>
                    ...
                    <div class="space-y-5">
                        ...
                        <div class="vendor-card overflow-hidden">
                            <div class="bg-gradient-to-r from-slate-800 to-slate-900 px-6 py-5">
                                <div class="flex items-center gap-3">
                                    ...
                                    <div>
                                        <h2 class="text-base font-bold text-white">Review Your Changes</h2>
                                        <p class="mt-0.5 text-xs text-slate-300">Please verify all details before saving</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="vendor-card overflow-hidden">
                            ...
                            <div class="px-5 pb-4">
                                ...
                                <div x-show="form.destination_mode === 'per_item'" class="mt-3 flex items-start gap-2.5 rounded-lg bg-blue-50 px-4 py-3">
                                    ...
                                    <span class="text-xs text-blue-700">Delivery addresses are set for each item individually on the shipment details page.</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <button type="button" @click="saveShipment()" :disabled="saving"
                                ...
                                <span x-text="saving ? 'Saving...' : 'Update Shipment'"></span>
                            </button>
                        </div>
                    </div>
                </div>
