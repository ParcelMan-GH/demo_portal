...
<div class="profile-page" x-data="driverProfilePage()">
                ...
                <div class="profile-hero-info">
                    ...
                    <div class="profile-hero-meta">
                        ...
                        <div class="profile-hero-meta-item" x-show="profile?.vehicle_type">
                            ...
                            <span style="text-transform:capitalize;" x-text="profile?.vehicle_type"></span>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="profile-section">
        <div class="profile-section-head">
            ...
            <button type="button" x-show="!editMode" @@click="startEdit()"
                    style="padding:0.4rem 0.9rem;border-radius:10px;font-size:0.78rem;font-weight:600;color:#059669;background:#d1fae5;border:1px solid #a7f3d0;cursor:pointer;">
                Edit Profile
            </button>
        </div>
        <div class="profile-section-body">
            ...
            <div class="profile-info-grid">
                ...
                <div style="display:flex;align-items:flex-start;gap:0.75rem;background:#f8fafc;border:1px solid #e9f0f8;border-radius:14px;padding:1rem 1.125rem;">
                    ...
                    <div style="min-width:0;">
                        <div style="font-size:0.68rem;font-weight:600;color:#94a3b8;text-transform:uppercase;letter-spacing:0.06em;margin-bottom:0.2rem;">Name</div>
                ...
                <div style="display:flex;align-items:flex-start;gap:0.75rem;background:#f8fafc;border:1px solid #e9f0f8;border-radius:14px;padding:1rem 1.125rem;">
                    ...
                    <div style="min-width:0;">
                        <div style="font-size:0.68rem;font-weight:600;color:#94a3b8;text-transform:uppercase;letter-spacing:0.06em;margin-bottom:0.2rem;">Email</div>
                ...
                <div style="display:flex;align-items:flex-start;gap:0.75rem;background:#f8fafc;border:1px solid #e9f0f8;border-radius:14px;padding:1rem 1.125rem;">
                    ...
                    <div style="min-width:0;">
                        <div style="font-size:0.68rem;font-weight:600;color:#94a3b8;text-transform:uppercase;letter-spacing:0.06em;margin-bottom:0.2rem;">Phone</div>
                ...
                <div style="display:flex;align-items:flex-start;gap:0.75rem;background:#f8fafc;border:1px solid #e9f0f8;border-radius:14px;padding:1rem 1.125rem;">
                    <div style="flex-shrink:0;width:34px;height:34px;border-radius:10px;background:#f0fdf4;display:flex;align-items:center;justify-content:center;">
                        <svg width="16" height="16" fill="none" stroke="#16a34a" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 17a2 2 0 11-4 0 2 2 0 014 0zM19 17a2 2 0 11-4 0 2 2 0 014 0zM13 16V6a1 1 0 00-1-1H4a1 1 0 00-1 1v10a1 1 0 001 1h1m8-1a1 1 0 01-1 1H9m4-1V8a1 1 0 011-1h2.586a1 1 0 01.707.293l3.414 3.414a1 1 0 01.293.707V16a1 1 0 01-1 1h-1m-6-1a1 1 0 001 1h1M5 17a2 2 0 104 0m-4 0a2 2 0 114 0m6 0a2 2 0 104 0m-4 0a2 2 0 114 0"/></svg>
                    </div>
                    <div style="min-width:0;">
                        <div style="font-size:0.68rem;font-weight:600;color:#94a3b8;text-transform:uppercase;letter-spacing:0.06em;margin-bottom:0.2rem;">Vehicle Type</div>
                        <div style="font-size:0.9rem;font-weight:700;color:#0f172a;text-transform:capitalize;" x-text="profile?.vehicle_type || '—'"></div>
                    </div>
                </div>
                ...
                <div style="display:flex;align-items:flex-start;gap:0.75rem;background:#f8fafc;border:1px solid #e9f0f8;border-radius:14px;padding:1rem 1.125rem;">
                    <div style="flex-shrink:0;width:34px;height:34px;border-radius:10px;background:#fdf4ff;display:flex;align-items:center;justify-content:center;">
                        <svg width="16" height="16" fill="none" stroke="#9333ea" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 7h.01M7 3h5c.512 0 1.024.195 1.414.586l7 7a2 2 0 010 2.828l-7 7a2 2 0 01-2.828 0l-7-7A1.994 1.994 0 013 12V7a4 4 0 014-4z"/></svg>
                    </div>
                    <div style="min-width:0;">
                        <div style="font-size:0.68rem;font-weight:600;color:#94a3b8;text-transform:uppercase;letter-spacing:0.06em;margin-bottom:0.2rem;">Vehicle Number</div>
                        <div style="font-size:0.9rem;font-weight:700;color:#0f172a;" x-text="profile?.vehicle_number || '—'"></div>
                    </div>
                </div>

                {{-- License Number --}}
                <div style="display:flex;align-items:flex-start;gap:0.75rem;background:#f8fafc;border:1px solid #e9f0f8;border-radius:14px;padding:1rem 1.125rem;">
                    <div style="flex-shrink:0;width:34px;height:34px;border-radius:10px;background:#fff1f2;display:flex;align-items:center;justify-content:center;">
                        <svg width="16" height="16" fill="none" stroke="#e11d48" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 6H5a2 2 0 00-2 2v9a2 2 0 002 2h14a2 2 0 002-2V8a2 2 0 00-2-2h-5m-4 0V5a2 2 0 114 0v1m-4 0a2 2 0 104 0m-5 8a2 2 0 100-4 2 2 0 000 4zm0 0c1.306 0 2.417.835 2.83 2M9 14a3.001 3.001 0 00-2.83 2M15 11h3m-3 4h2"/></svg>
                    </div>
                    <div style="min-width:0;">
                        <div style="font-size:0.68rem;font-weight:600;color:#94a3b8;text-transform:uppercase;letter-spacing:0.06em;margin-bottom:0.2rem;">License Number</div>
                        <div style="font-size:0.9rem;font-weight:700;color:#0f172a;" x-text="profile?.license_number || '—'"></div>
                    </div>
                </div>

                {{-- Base Location --}}
                <div style="display:flex;align-items:flex-start;gap:0.75rem;background:#f8fafc;border:1px solid #e9f0f8;border-radius:14px;padding:1rem 1.125rem;">
                    <div style="flex-shrink:0;width:34px;height:34px;border-radius:10px;background:#fff7ed;display:flex;align-items:center;justify-content:center;">
                        <svg width="16" height="16" fill="none" stroke="#ea580c" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z"/><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z"/></svg>
                    </div>
                    <div style="min-width:0;">
                        <div style="font-size:0.68rem;font-weight:600;color:#94a3b8;text-transform:uppercase;letter-spacing:0.06em;margin-bottom:0.2rem;">Base Location</div>
                        <div style="font-size:0.9rem;font-weight:700;color:#0f172a;" x-text="profile?.base_location || '—'"></div>
                    </div>
                </div>
            ...
            <form x-show="editMode" x-cloak @@submit.prevent="saveProfile()" class="profile-form-grid">
                ...
                <div class="profile-form-field">
                    ...
                    <select x-model="profileForm.vehicle_type"
                        ...
                        <template x-for="type in vehicleTypeOptions" :key="type">
                            <option :value="type" :selected="type === profileForm.vehicle_type" x-text="type"></option>
                        </template>
                    </select>
                </div>
                <div class="profile-form-field">
                ...
                <div class="profile-pw-actions" style="grid-column:1/-1;">
                    <button type="button" @@click="cancelEdit()" class="profile-discard-btn">Close</button>
    ...
    <div class="profile-section">
        ...
        <div class="profile-section-body">
            ...
            <div x-show="passwordAlert" x-cloak
                 x-transition:enter="transition ease-out duration-300"
                 x-transition:enter-start="opacity-0 -translate-y-4"
                 x-transition:enter-end="opacity-100 translate-y-0"
                 x-transition:leave="transition ease-in duration-200"
                 x-transition:leave-start="opacity-100 translate-y-0"
                 x-transition:leave-end="opacity-0 -translate-y-4"
                 class="profile-alert" :class="passwordAlert?.type">
            ...
            <form @@submit.prevent="changePassword()" class="profile-form-grid full">
                ...
                <div class="profile-pw-actions">
                    <button type="button" @@click="passwordForm.current_password='';passwordForm.new_password='';passwordForm.confirm_password='';passwordAlert=null;" class="profile-discard-btn">Close</button>
