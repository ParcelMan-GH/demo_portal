...
@section('breadcrumb-current', 'Create User')
    ...
    <div class="max-w-2xl">
        <div class="bg-white rounded-lg shadow">
            ...
            <form
                ...
                x-data="{
                    showPassword: false,
                    hasWarehouse: {{ old('warehouse_id', $selectedWarehouseId ?? '') ? 'true' : 'false' }},
                    syncRoleScope() {
                        ...
                        @forelse($roles as $role)
                            ...
                            >
                                <input
                                    ...
                                    data-role-input
                                    value="{{ $role->id }}"
                                    {{ (string) old('role_id', old('roles.0', '')) === (string) $role->id ? 'checked' : '' }}
