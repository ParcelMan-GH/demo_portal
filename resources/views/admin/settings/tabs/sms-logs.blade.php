<div x-data="smsLogsTable()" x-init="loadData(); initDateRange()" class="space-y-4">
        ...
        <div class="mb-4 flex flex-col gap-3 xl:flex-row xl:items-end xl:justify-between">
            <div class="w-full xl:max-w-md">
                ...
                <div class="relative">
                    ...
                    <input type="text" x-model="search" @@input.debounce.500ms="refreshData()" placeholder="Search recipient, message, or status..."
                        ...
                        <tr>
                            <td colspan="4" class="px-4 py-10 text-center">
                                <div class="flex flex-col items-center gap-2">
                                    ...
                                    <p class="text-sm font-medium text-slate-500">No SMS logs match the current filters</p>
                                </div>
                            </td>
                        </tr>
                    </template>
    ...
    Alpine.data('smsLogsTable', () => ({
        ...
        async loadData() {
            ...
            try {
                ...
                const response = await fetch(window.settingsConfig.smsLogsDataEndpoint + '?' + params.toString(), { headers: { 'Accept': 'application/json', 'X-Requested-With': 'XMLHttpRequest' } });
