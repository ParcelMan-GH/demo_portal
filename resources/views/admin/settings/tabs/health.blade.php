<div class="space-y-6">
    ...
    <div class="flex flex-wrap gap-3 mt-8 p-6 bg-slate-50/70 rounded-2xl border border-slate-200/50">
        ...
        <a href="/admin/horizon" target="_blank"
           class="inline-flex items-center gap-2 px-4 py-2.5 bg-gradient-to-r from-indigo-600 to-purple-600 rounded-xl text-sm font-medium text-white hover:from-indigo-700 hover:to-purple-700 transition-all shadow-sm">
            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
