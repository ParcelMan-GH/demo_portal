            ...
            <table class="w-full min-w-[900px] md:min-w-full divide-y divide-slate-200/50 text-xs">
                <thead class="bg-slate-50/50">
                    <tr>
                        ...
                        <th x-show="visibleColumns.verified" class="px-4 py-2 text-left text-[10px] font-semibold text-slate-500 uppercase tracking-wider">
                            VERIFIED
                        </th>
                ...
                <tbody class="bg-transparent divide-y divide-slate-100/50">
                    ...
                    <template x-for="vendor in vendors" :key="vendor.id">
                        <tr class="hover:bg-slate-50/70">
                            ...
                            <td x-show="visibleColumns.verified" class="px-4 py-2.5 whitespace-nowrap text-xs">
                                <span
                                    class="inline-flex items-center rounded-full px-2 py-0.5 text-[10px] font-semibold"
                                    :class="vendor.is_phone_verified ? 'bg-blue-100 text-blue-700' : 'bg-amber-100 text-amber-700'"
                                    x-text="vendor.is_phone_verified ? 'Verified' : 'Pending'"
                                ></span>
                            </td>
            ...
            >
                ...
                <form @submit.prevent="saveVendor()">
                    <div class="space-y-5 px-6 py-6 max-h-[calc(100vh-240px)] overflow-y-auto">
                            ...
                            <div x-show="modalMode !== 'view'" class="bg-gradient-to-br from-blue-50/50 to-indigo-50/30 rounded-2xl p-5 border border-blue-100/50">
                                <div class="flex items-center gap-2 mb-4">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-xs text-slate-500">4-digit access code for vendor portal</p>
                                    </div>
                                </div>
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    ...
                                    <div>
                                        <label class="block text-sm font-semibold text-slate-700 mb-2">
                                            PIN <span x-show="modalMode === 'add'" class="text-rose-500">*</span>
                                        ...
                                        <div class="relative">
                                            ...
                                            <input
                                                ...
                                                inputmode="numeric"
                                                pattern="[0-9]{4}"
                                                class="w-full pl-10 pr-4 py-2.5 border-2 border-blue-200 rounded-xl bg-white focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 text-sm text-slate-900 placeholder-slate-400 transition-all font-mono tracking-widest"
                                                placeholder="• • • •"
                                                maxlength="4"
                                    ...
                                    <div>
                                        <label class="block text-sm font-semibold text-slate-700 mb-2">
                                            Confirm PIN <span x-show="modalMode === 'add'" class="text-rose-500">*</span>
                                            <span x-show="modalMode === 'edit'" class="text-slate-400 text-xs font-normal">(optional)</span>
                                        </label>
                                        <div class="relative">
                                            <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                                        ...
                                        <template x-if="errors.pin_confirmation">
                                            <p class="mt-1.5 text-xs text-rose-600 flex items-center gap-1">
                                                ...
                                                <span x-text="errors.pin_confirmation[0]"></span>
                                            </p>
                                        </template>
                                        <template x-if="form.pin && form.pin_confirmation && form.pin !== form.pin_confirmation">
                                        ...
                                        <template x-if="form.pin && form.pin_confirmation && form.pin === form.pin_confirmation && form.pin.length === 4">
                                ...
                                <div class="grid grid-cols-2 gap-4">
                                    ...
                                    <div class="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-xl p-4 border border-blue-100">
                                        <div class="flex items-center gap-2 mb-2">
                                            ...
                                            <span class="text-xs font-bold text-slate-700">Phone Status</span>
                                        </div>
                                        <span
                                            class="inline-flex items-center rounded-full px-3 py-1 text-xs font-bold shadow-sm"
                                            :class="form.is_phone_verified ? 'bg-blue-500 text-white' : 'bg-amber-500 text-white'"
                                            x-text="form.is_phone_verified ? 'Verified' : 'Pending'"
                                        ></span>
                                    </div>
                                </div>
                            </template>
