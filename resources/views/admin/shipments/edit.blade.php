                ...
                <div>
                    ...
                    <div class="relative" @@click.outside="assignModal.driverPickerOpen = false">
                        <input type="search" x-model="assignModal.driverSearch"
                               ...
                               role="combobox" aria-autocomplete="list" aria-controls="shipment-editor-rider-listbox"
                               :aria-expanded="assignModal.driverPickerOpen"
                               :aria-activedescendant="assignModal.driverActiveIndex >= 0 ? `shipment-editor-rider-${filteredAssignmentDrivers()[assignModal.driverActiveIndex]?.id}` : null"
                        ...
                        <div x-show="assignModal.driverPickerOpen" x-cloak class="absolute left-0 right-0 z-40 mt-1 overflow-hidden rounded-xl border border-slate-200 bg-white shadow-xl">
                            <div id="shipment-editor-rider-listbox" role="listbox" aria-label="Pickup riders" class="max-h-64 overflow-y-auto">
                                <template x-for="(driver, index) in filteredAssignmentDrivers()" :key="driver.id">
                                    <button type="button" :id="`shipment-editor-rider-${driver.id}`" role="option"
