            ...
            <div class="p-6 space-y-5">
                    ...
                    <div class="flex gap-2">
                        <div class="relative flex-1">
                            <input type="text" x-model="vendorPhone" placeholder="e.g. 0241234567"
                                   ...
                                   class="w-full px-3 py-2 text-sm border border-slate-200 rounded-xl focus:ring-2 focus:ring-blue-500/20 focus:border-blue-400 outline-none">
                        </div>
                ...
                <div x-show="vendorFound === true && vendorData" class="bg-emerald-50 rounded-xl border border-emerald-200 p-4">
                    ...
                    <div class="mt-3 flex gap-2">
                        <button @@click="selectVendor(vendorData)" class="px-4 py-1.5 bg-emerald-600 hover:bg-emerald-700 text-white text-xs font-semibold rounded-lg transition-colors">
                            Use This Vendor
                        </button>
                        <button @@click="resetVendor()" class="px-4 py-1.5 bg-white hover:bg-slate-50 text-slate-600 text-xs font-semibold rounded-lg border border-slate-200 transition-colors">
                            Search Again
                        </button>
                    </div>
                </div>
                ...
                <div x-show="vendorFound === false" class="bg-amber-50 rounded-xl border border-amber-200 p-4">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
                        ...
                        <div>
                            ...
                            <input type="text" x-model="newVendor.phone" class="w-full px-3 py-1.5 text-sm border border-slate-200 rounded-lg bg-slate-50 focus:ring-2 focus:ring-blue-500/20 focus:border-blue-400 outline-none" readonly>
                        </div>
                        <div>
                ...
                <div x-show="vendorId && step === 1" class="bg-blue-50 rounded-xl border border-blue-200 p-4">
                    <div class="flex items-center justify-between">
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                <p class="text-sm font-semibold text-slate-900">Vendor Selected: <span x-text="vendorData?.name"></span></p>
                                <p class="text-[11px] text-slate-500" x-text="vendorData?.phone"></p>
                            </div>
                        </div>
                        <button @@click="step = 2" class="px-5 py-2 bg-blue-600 hover:bg-blue-700 text-white text-xs font-semibold rounded-xl transition-colors">
                            Next: Items & Delivery
                            <svg class="w-3.5 h-3.5 inline ml-1" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"/></svg>
                        </button>
                    </div>
                </div>
            </div>
        ...
        <div class="space-y-5">
            ...
            <div class="bg-white rounded-2xl border border-slate-200 shadow-sm">
                <div class="px-6 py-4 border-b border-slate-100 flex items-center justify-between">
                    ...
                    <button @@click="addItem()" class="px-3 py-1.5 bg-blue-600 hover:bg-blue-700 text-white text-[11px] font-semibold rounded-lg transition-colors">
                        + Add Item
                    </button>
                </div>
                                        ...
                                        <div class="bg-slate-50 rounded-xl p-3 space-y-3 border border-slate-100">
                                            ...
                                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
                                                <div>
                                                    ...
                                                    <input type="text" x-model="item.delivery.recipient_name"
                                                ...
                                                <div>
                                                    ...
                                                    <input type="text" x-model="item.delivery.recipient_phone"
                                                           class="w-full px-3 py-1.5 text-sm border border-slate-200 rounded-lg focus:ring-2 focus:ring-blue-500/20 focus:border-blue-400 outline-none bg-white">
                                                </div>
                                            </div>
                                            <!-- Location typeahead -->
                                            ...
                                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
                                                <div>
                                                    ...
                                                    <input type="text" x-model="item.delivery.landmark"
                                                           class="w-full px-3 py-1.5 text-sm border border-slate-200 rounded-lg focus:ring-2 focus:ring-blue-500/20 focus:border-blue-400 outline-none bg-white">
                                                </div>
                                                <div>
                                                    <label class="block text-[10px] font-semibold text-slate-500 mb-1">Instructions</label>
                                                    <input type="text" x-model="item.delivery.instructions"
                                                           class="w-full px-3 py-1.5 text-sm border border-slate-200 rounded-lg focus:ring-2 focus:ring-blue-500/20 focus:border-blue-400 outline-none bg-white">
                                                </div>
                                            </div>
                                        </div>
            ...
            <div x-show="destinationMode === 'single'" class="bg-white rounded-2xl border border-slate-200 shadow-sm p-6 space-y-4">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
                    <div>
                        ...
                        <input type="text" x-model="delivery.landmark"
                               class="w-full px-3 py-1.5 text-sm border border-slate-200 rounded-lg focus:ring-2 focus:ring-blue-500/20 focus:border-blue-400 outline-none">
                    </div>
                    <div>
                        <label class="block text-[10px] font-semibold text-slate-500 uppercase tracking-wider mb-1">Delivery Instructions</label>
                        <input type="text" x-model="delivery.instructions"
                               class="w-full px-3 py-1.5 text-sm border border-slate-200 rounded-lg focus:ring-2 focus:ring-blue-500/20 focus:border-blue-400 outline-none">
                    </div>
                </div>
            </div>
            ...
            <!-- Receiving Warehouse -->
            <div class="bg-white rounded-2xl border border-slate-200 shadow-sm p-6">
                <h2 class="text-sm font-bold text-slate-900 mb-3">Receiving Warehouse</h2>
                <select x-model="warehouseId" class="w-full px-3 py-2 text-sm border border-slate-200 rounded-xl focus:ring-2 focus:ring-blue-500/20 focus:border-blue-400 outline-none">
            ...
            <!-- Navigation -->
            <div class="flex items-center justify-between">
                <button @@click="step = 1" class="px-4 py-2 bg-white hover:bg-slate-50 text-slate-600 text-xs font-semibold rounded-xl border border-slate-200 transition-colors">
                    <svg class="w-3.5 h-3.5 inline mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 19l-7-7 7-7"/></svg>
                    Back
                </button>
        ...
        <div class="space-y-5">
            ...
            <div class="bg-white rounded-2xl border border-slate-200 shadow-sm p-5">
                <div class="flex items-center gap-3 mb-3">
                    ...
                    <div>
                        <h3 class="text-sm font-bold text-slate-900">Vendor</h3>
                        <p class="text-[11px] text-slate-500"><span x-text="vendorData?.name"></span> &mdash; <span x-text="vendorData?.phone"></span></p>
                    </div>
                </div>
            </div>
                        ...
                        <div class="px-5 py-3 flex items-center justify-between">
                            <div>
                                ...
                                <template x-if="destinationMode === 'per_item' && item.delivery.recipient_name">
                                    <p class="text-[10px] text-slate-400 mt-0.5">To: <span x-text="item.delivery.recipient_name"></span> &mdash; <span x-text="item.delivery.selectedLocation?.display || 'No location'"></span></p>
                                </template>
                            </div>
                        </div>
                    </template>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
                <div x-show="destinationMode === 'single'" class="bg-white rounded-2xl border border-slate-200 shadow-sm p-5">
                    ...
                    <p x-show="delivery.landmark" class="text-[11px] text-slate-400 mt-0.5">Landmark: <span x-text="delivery.landmark"></span></p>
                </div>
                <div class="bg-white rounded-2xl border border-slate-200 shadow-sm p-5">
                    <h3 class="text-xs font-bold text-slate-400 uppercase tracking-wider mb-2">Receiving Warehouse</h3>
                    <p class="text-sm font-semibold text-slate-900" x-text="config.warehouses.find(w => w.id == warehouseId)?.name || '—'"></p>
                    <p class="text-xs text-slate-500" x-text="config.warehouses.find(w => w.id == warehouseId)?.code || ''"></p>
                </div>
            </div>

            <!-- Submit -->
            <div class="flex items-center justify-between">
                <button @@click="step = 2" class="px-4 py-2 bg-white hover:bg-slate-50 text-slate-600 text-xs font-semibold rounded-xl border border-slate-200 transition-colors">
                    <svg class="w-3.5 h-3.5 inline mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 19l-7-7 7-7"/></svg>
                    Back
                </button>
    ...
    return {
        ...
        async lookupVendor() {
            ...
            try {
                ...
                this.vendorError = 'Failed to lookup vendor. Please try again.';
            }
        ...
        async createVendor() {
            ...
            try {
                ...
                if (json.success) {
                    ...
                    this.vendorError = Object.values(json.errors).flat().join(', ');
                } else {
                    this.vendorError = json.message || 'Failed to create vendor.';
                }
            } catch {
                this.vendorError = 'Failed to create vendor. Please try again.';
            }
            this.creatingVendor = false;
        },

        searchLocation(deliveryObj) {
            const q = deliveryObj.locationQuery;
            if (q.length < 2) {
                deliveryObj.locationResults = [];
                deliveryObj._showDropdown = false;
                return;
            }
            deliveryObj.selectedLocation = null;
            deliveryObj.region_id = '';
            deliveryObj.district_id = '';
            deliveryObj.town = '';

            clearTimeout(deliveryObj._timeout);
            deliveryObj._timeout = setTimeout(async () => {
                try {
                    const res = await fetch(this.config.locationSearchUrl + '?q=' + encodeURIComponent(q), {
                        headers: { 'X-Requested-With': 'XMLHttpRequest', 'Accept': 'application/json' }
                    });
                    const json = await res.json();
                    deliveryObj.locationResults = json.locations || [];
                    deliveryObj._showDropdown = deliveryObj.locationResults.length > 0;
                } catch {
                    deliveryObj.locationResults = [];
                }
            }, 300);
        ...
        selectLocation(deliveryObj, loc) {
            deliveryObj.selectedLocation = loc;
            deliveryObj.locationQuery = loc.display;
            deliveryObj.locationResults = [];
            deliveryObj._showDropdown = false;
            deliveryObj.region_id = loc.region.id;
            deliveryObj.district_id = loc.district.id;
            deliveryObj.town = loc.name;
        },
        ...
        canProceedToReview() {
            ...
            for (const item of this.items) {
                ...
                if (this.destinationMode === 'per_item') {
                    if (!item.delivery.recipient_name || !item.delivery.recipient_phone || !item.delivery.region_id) return false;
                }
            }
            if (this.destinationMode === 'single') {
                if (!this.delivery.recipient_name || !this.delivery.recipient_phone || !this.delivery.region_id) return false;
            }
            return true;
        },
        ...
        async submitShipment() {
            ...
            const payload = {
                ...
                items: this.items.map(i => ({
                    ...
                    delivery: this.destinationMode === 'per_item' ? {
                        ...
                        recipient_phone: i.delivery.recipient_phone,
                        region_id: i.delivery.region_id,
                        district_id: i.delivery.district_id,
                        town: i.delivery.town,
                        landmark: i.delivery.landmark,
                        instructions: i.delivery.instructions,
                    } : undefined,
                })),
            };
            ...
            if (this.destinationMode === 'single') {
                payload.delivery = {
                    ...
                    region_id: this.delivery.region_id,
                    district_id: this.delivery.district_id,
                    town: this.delivery.town,
            ...
            try {
                ...
                if (json.success) {
                    ...
                    this.submitError = Object.values(json.errors).flat().join(', ');
                } else {
                    this.submitError = json.message || 'Failed to create shipment.';
                }
            } catch {
