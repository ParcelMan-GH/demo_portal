                                                ...
                                                <div class="grid grid-cols-2 gap-3">
                                                    ...
                                                    <div>
                                                        ...
                                                        <select x-model="pkg.delivery_district_id"
                                                            ...
                                                            <template x-for="d in (pkg._districts || [])" :key="d.id"><option :value="String(d.id)" :selected="String(d.id) === String(pkg.delivery_district_id)" x-text="d.name"></option></template>
                                                        </select>
                                                    </div>
                                                </div>
                                                <div class="grid grid-cols-2 gap-3">
