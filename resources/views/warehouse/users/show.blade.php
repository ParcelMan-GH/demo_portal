        ...
        <div class="relative">
            ...
            <div class="relative px-6 lg:px-8 py-6">
                ...
                <div class="mb-6 flex items-center justify-between gap-3">
                    <a href="{{ route('warehouse.users.index') }}" class="group inline-flex items-center gap-2 px-3 py-1.5 rounded-lg bg-white/10 hover:bg-white/20 border border-white/20 text-white text-sm font-medium transition-all backdrop-blur-sm hover:shadow-md">
                    ...
                    <div class="flex flex-wrap items-center justify-end gap-2">
                        ...
                        @if(!$isSelf)
                            <form action="{{ route('warehouse.users.toggle-active', $admin) }}" method="POST"
