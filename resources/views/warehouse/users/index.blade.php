            ...
            <div class="flex items-center justify-between">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <p class="mt-0.5 text-sm text-slate-500">Manage users assigned to this warehouse</p>
                    </div>
                </div>
                <span class="inline-flex items-center px-3 py-1.5 rounded-full text-sm font-medium bg-slate-100 text-slate-700" x-text="meta.total + ' Warehouse Users'">
                </span>
            </div>
        </div>
