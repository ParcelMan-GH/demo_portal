    ...
    <div class="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
        <div class="flex flex-wrap items-center justify-between gap-3">
            <div>
                ...
                <p class="text-sm text-slate-500">Pickups assigned to this warehouse and waiting to be received.</p>
            </div>
            ...
            <table class="min-w-full divide-y divide-slate-200 text-sm">
                <thead class="bg-slate-50">
                    <tr>
                        ...
                        <th x-show="visibleColumns.target_warehouse" class="px-4 py-3 text-left text-[11px] font-semibold uppercase tracking-[0.08em] text-slate-500">Target Warehouse</th>
                    </tr>
                </thead>
                <tbody class="divide-y divide-slate-100 bg-white">
                    <tr x-show="!loading && rows.length === 0" x-cloak>
                        <td :colspan="visibleColumnCount()" class="px-4 py-10 text-center text-sm text-slate-500">No pending receipts found.</td>
                    </tr>
                    <template x-for="row in rows" :key="row.id">
                        <tr class="hover:bg-slate-50/70">
                            ...
                            <td x-show="visibleColumns.status" class="px-4 py-3">
                                <span class="inline-flex rounded-full bg-slate-100 px-2.5 py-1 text-xs font-semibold text-slate-700" x-text="row.status || '-' "></span>
                            </td>
                            ...
                            <td x-show="visibleColumns.target_warehouse" class="px-4 py-3 text-slate-600" x-text="row.target_warehouse || '-' "></td>
                        </tr>
                    </template>
                </tbody>
            </table>
