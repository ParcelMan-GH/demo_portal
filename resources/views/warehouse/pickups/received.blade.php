            ...
            <div class="flex items-center justify-between">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <p class="mt-0.5 text-sm text-slate-500">Pickups already received at this warehouse.</p>
                    </div>
                </div>
                ...
                <table class="min-w-full divide-y divide-slate-200/50 text-xs">
                    <thead class="bg-slate-50/50">
                        <tr>
                            ...
                            <th x-show="visibleColumns.receive_notes" class="px-4 py-2 text-left text-[10px] font-semibold text-slate-500 uppercase tracking-wider">RECEIVE NOTES</th>
                    ...
                    <tbody class="bg-transparent divide-y divide-slate-100/50">
                        <tr x-show="!loading && rows.length === 0" x-cloak>
                            <td :colspan="visibleColumnCount()" class="px-4 py-8 text-center text-gray-500 text-xs">No received pickups found.</td>
                        </tr>
                        <template x-for="row in rows" :key="row.id">
                            <tr class="hover:bg-slate-50/70">
                                ...
                                <td x-show="visibleColumns.receive_notes" class="px-4 py-2.5 text-xs text-slate-600" x-text="row.receive_notes || '-'"></td>
