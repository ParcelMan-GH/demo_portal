@php
    $hideEmptyContainers = $hideEmptyContainers ?? false;
    $singleColumnContainers = $singleColumnContainers ?? false;
    $containers = $manifest->containers
        ->when($hideEmptyContainers, fn ($items) => $items->filter(fn ($container) => $container->items->isNotEmpty()))
...
<div class="bg-white rounded-2xl border border-slate-200 shadow-sm">
        ...
        <div class="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
            ...
            @if($canManageContainers)
                <button
                    ...
                    class="inline-flex items-center justify-center gap-2 px-3.5 py-2 rounded-xl bg-orange-600 hover:bg-orange-700 text-white text-xs font-semibold shadow-sm transition-colors disabled:opacity-50"
                >
    ...
    <div class="px-6 py-5">
        ...
        @else
            <div class="{{ $singleColumnContainers ? 'space-y-4' : 'grid grid-cols-1 xl:grid-cols-2 gap-4' }}">
